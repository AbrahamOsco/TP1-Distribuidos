...
class EOFDTO:
    ...
    def __init__(self, operation_type = 0, client_id = 0, amount_data = 0, old_operation_type = 0):
        ...
        self.data_process = amount_data
        self.old_operation_type = old_operation_type

    @classmethod
    def create(cls, eofDTO):
        return EOFDTO(eofDTO.operation_type, eofDTO.client_id, eofDTO.data_process, eofDTO.old_operation_type)

    def load(self, a_eof_dto):
        self.operation_type = a_eof_dto.operation_type 
        self.data_process = a_eof_dto.data_process   
        self.client_id = a_eof_dto.client_id
        self.old_operation_type = a_eof_dto.old_operation_type
        return EOFDTO(self.operation_type, self.client_id, self.data_process, self.old_operation_type)
    ...
    def initialize_amount_and_type(self, a_amount):
        ...
        self.data_process = a_amount
    
    def set_amount_data(self, new_amount):
        self.data_process = new_amount
    ...
    def serialize(self):
        ...
        eof_bytes.extend(self.data_process.to_bytes(8, byteorder='big'))
        return eof_bytes
