...
class SelectQ1:
    ...
    def __init__(self):
        ...
        self.broker.create_queue(name =QUEUE_FILTER_SELECTQ1, callback = self.handler_select_platforms())
    ...
    def handler_select_platforms(self):
        def handler_message(ch, method, properties, body):
            ...
            if result_dto.operation_type == OperationType.OPERATION_TYPE_EOF_DTO :
                ...
                self.select_platforms(result_dto)
