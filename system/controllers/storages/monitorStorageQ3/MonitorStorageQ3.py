...
class MonitorStorageQ3:
    def __init__(self):
        ...
        self.broker.create_queue(name =QUEUE_SELECTIDNAME_MONITORSTORAGEQ3, callback = self.handler_insert_data_monitor())
        self.broker.create_queue(name =QUEUE_MONITORSTORAGEQ3_GROUPER_TOPPOSIREVIEW)
    ...
    def send_batches_results(self):
        ...
        while len(self.games) > 0:
            ...
            self.broker.public_message(queue_name =QUEUE_MONITORSTORAGEQ3_GROUPER_TOPPOSIREVIEW, message =monitor_resultDTO.serialize())
